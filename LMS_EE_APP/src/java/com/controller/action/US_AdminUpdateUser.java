...
public class US_AdminUpdateUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getSession().getAttribute("user") != null) {
                ...
                String URL = ResAccessUrl.USER_SERVICE + "UserProfile/" + obj.getInt("userID") + "/" + fname + "/" + lname + "/" + mobile + "/" + address + "/" + userProfileType + "/" + country + "/" + lhid;
                String METHOD = "PUT";
